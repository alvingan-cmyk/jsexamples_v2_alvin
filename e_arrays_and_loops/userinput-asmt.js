...
// 2. Do-while loop
// Since it is a must to obtain the user's name, do the executeable block AT LEAST ONCE

let getName2 = "";

do {
    getName2 = prompt("Please enter your name: "); // Do first
} while (getName2 ===""); // Check later
...
function updateMove(m=""){
            ...
            if(m===QUIT) return console.log("You quit the game.")// Tell user he quite the game
